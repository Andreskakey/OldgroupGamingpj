...
public class GameplayScene implements IGameScene
{
    ...
    public void onStart()
    {
        ...
        spawner.spawnBackground(Engine.getResourceManager().loadImage("college.png"));
        spawner.spawnPlayer(new Point(900, 955), Engine.getResourceManager().loadImage("player.png"));
        ...
        ebm = new EnemyBoardManager(spawner, new Point(450, 100), 1.5);
