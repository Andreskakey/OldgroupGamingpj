...
public class ListOption
{
    public ListOption(String optionName, boolean isSelected, ListMenu manager)
    {
        ...
        selectSound = Engine.getResourceManager().loadSound("button_selected.wav");
        pressedSound = Engine.getResourceManager().loadSound("button_pressed.wav");
    }
    ...
    {
        Engine.getAudioPlayer().playOnce(pressedSound);
        action.accept(null);
    }

    public void select()
    {
        Engine.getAudioPlayer().playOnce(selectSound);
        isSelected = true;
    }
